        ...
        {cartToBuying.map((item, index) => (
          <div key={index} className="cart">
            <button
              ...
              style={{
                backgroundImage: `url(imgForProject/icon/Close.svg)`,
              }}
            ...
            <div className="count__buying-item button">
              <button
                ...
                style={{ backgroundImage: `url(imgForProject/icon/Minus.svg)` }}
              ...
              <button
                ...
                style={{ backgroundImage: `url(imgForProject/icon/Plus.svg)` }}
                onClick={() => updateCount(item.itemId, 1)}
              ></button>
            </div>
