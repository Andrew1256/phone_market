  ...
  if (!product) {
    return (
      <div
        ...
        style={{ backgroundImage: `url(img/product-not-found.png)` }}
      />
    );
  }

  const currentColor = product.id.split('-').at(-1);
        ...
        <section className="second__section">
          ...
          <div className="buttons__block">
            ...
            >
              <div
                style={{
                  backgroundImage: `url(imgForProject/icon/${
                    isProductInStorage(product.id, favorites)
                      ? 'Favourites_field.svg'
                      : 'Favourites.svg'
                  })`,
                }}
