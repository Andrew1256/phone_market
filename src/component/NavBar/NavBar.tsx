    ...
    <nav className="navigation">
      ...
      {!isMobile ? (
        <ul className="navigation-list">
          ...
          <li className="main__navigation last-icon__navigation">
            ...
            >
              ...
              <img
                ...
                src="imgForProject/icon/Favourites.svg"
                alt="Favorites"
              />
            </NavLink>
          </li>
          <li className="main__navigation last-icon__navigation">
            ...
            >
              ...
              <img
                className="icon-bag"
                src="imgForProject/icon/Shopping_bag.svg"
                alt="Shopping bag"
              />
            </NavLink>
          </li>
        ...
        <div className="main__navigation last-icon__navigation menu-item">
          <button
            className="icon-phones__menu"
            style={{
              backgroundImage: `url(${
                isOpenMenu
                  ? 'imgForProject/icon/white-close.svg'
                  : 'imgForProject/icon/Menu.svg'
              })`,
            }}
