...
const categoryImages = [
  ['img/category-phones.png', 'phones', '#6D6474', 'Mobile phones'],
  ['img/category-tablets.png', 'tablets', '#8D8D92', 'Tablets'],
  ['img/category-accessories.png', 'accessories', '#D53C51', 'Accessories'],
];
